-- =============================================================================
-- FYK Consolidated — 0004_functions.sql
-- Run BEFORE storage: the bucket policies in 0005_storage.sql call these functions,
-- so applying storage first fails with "function does not exist".
--
-- Helper functions, media access control, and album sharing.
--
-- This file adds:
