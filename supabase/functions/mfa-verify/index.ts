/**
 * Edge Function: mfa-verify
 * MFA verification — TOTP code, backup code, device trust
...
serve(async (req) => {
  ...
  try {
    ...
    // MFA verification — TOTP code, backup code, device trust
    console.log(`[mfa-verify] Processing for user ${userId}`, body);
    ...
    const result = {
      ...
      data: {
        message: "MFA verification — TOTP code, backup code, device trust",
