/**
 * Edge Function: mfa-setup
 * MFA enrollment — TOTP, backup codes, QR code
...
serve(async (req) => {
  ...
  try {
    ...
    // MFA enrollment — TOTP, backup codes, QR code
    console.log(`[mfa-setup] Processing for user ${userId}`, body);
    ...
    const result = {
      ...
      data: {
        message: "MFA enrollment — TOTP, backup codes, QR code",
