...
export type FilterPositionValue = (typeof FilterPosition)[keyof typeof FilterPosition];
...
const positionItems = [
  ...
  { value: FilterPosition.VersBottom, label: "Vers Bottom", Icon: ArrowDownRight },
