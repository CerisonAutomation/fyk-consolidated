/**
 * Grid virtualization window calculation.
 * Pure function extracted from open-grind — no framework dependencies.
 *
 * Given grid metrics (columns, cell size, gap), scroll offset, viewport size,
 * and overscan, computes which rows are visible and the padding needed above/below.
 */
