...
// Omega — award-winning, ray-traced, cinematic lighting, Behance top 1%, vs Local gay events, RSVP, calendar integration, travel mode, groups, vs Romeo events

export function EventsClientOmega() {
