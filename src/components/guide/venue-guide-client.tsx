...
export function VenueGuideClient() {
	...
	const [category, setCategory] = useState<VenueCategory | "all" | "saved">(
		"all",
	);
			...
			{viewMode === "map" ? (
				<div className="mb-4">
					<Suspense
						fallback={
							<div
								className="flex items-center justify-center rounded-2xl border border-line bg-surface-2"
								style={{ height: 400 }}
							>
	...
	return (
		<div className="overflow-hidden rounded-2xl border border-line bg-surface">
			<div
				...
				style={{
					background:
						"linear-gradient(90deg, var(--c-gold, #d4a017) 0%, transparent 100%)",
				}}
			/>
		...
		>
			...
			>
				...
				<div
					...
					style={{ background: gradient(venue.name) }}
				>
					<button
						onClick={onClose}
