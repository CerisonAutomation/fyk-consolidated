...
export function ShareLocationSheet({
	...
	const [status, setStatus] = useState<"idle" | "loading" | "shared" | "error">(
		"idle",
	);
	...
	return (
		<div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 backdrop-blur-sm">
			...
			{/* Glass bottom sheet */}
			<div
				className="relative w-full max-w-lg rounded-t-3xl border border-line/50 bg-surface/95 backdrop-blur-xl px-6 pb-8 pt-6 shadow-2xl"
				style={{
