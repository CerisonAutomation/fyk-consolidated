...
// enhanced — polished, detailed, subtle lighting, high-quality, vs Interest-based groups, members, chat, events, moderation, vs Romeo groups, Omolink multi-service
    ...
    <div className="mx-auto max-w-5xl p-4 pb-24">
      ...
      <div className="mt-8 rounded-[16px] border border-black/[0.06] bg-zinc-50 p-4">
        ...
        <ul className="mt-2 grid gap-1.5 text-[12px] leading-[1.4] text-zinc-600 md:grid-cols-2">
          ...
          <li className="flex gap-2"><span className="text-black">•</span> Bento grid, polished UI</li>
        </ul>
      </div>
    </div>
  );
