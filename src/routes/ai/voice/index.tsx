  ...
  return (
    <div className="max-w-2xl mx-auto p-4 space-y-4">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">Voice notes and avatar video with usage tracking and premium gating.</p>
      </div>
      ...
      <div className="border rounded-xl p-4">
        ...
        <ul className="text-xs text-muted-foreground mt-2 space-y-1 list-disc pl-4">
          ...
          <li>Avatar video — talking photo, 10 sec intro</li>
          <li>Translation dub — keep your voice, other language</li>
          <li>Usage limits — 10 per day free, unlimited premium</li>
      ...
      <div className="border rounded-xl p-4 space-y-3">
        ...
        <div className="flex gap-2">
          ...
          <button type="button" onClick={generate} disabled={loading} className="flex-1 py-2 bg-primary text-white rounded-full text-xs font-semibold disabled:opacity-50">{loading ? "Generating..." : "Generate Voice"}</button>
        </div>
        {audioUrl && (
          <div className="border rounded-xl p-3 bg-muted/50">
            <div className="text-xs text-muted-foreground">Generated audio</div>
            <audio controls src={audioUrl} className="w-full mt-2" />
            <div className="text-[11px] text-muted-foreground mt-1">Voice: {voice} — 200 chars — 5s — Heuristic model (ElevenLabs in production)</div>
          </div>
        )}
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="border rounded-xl p-3 text-center">
          ...
          <div className="text-[11px] text-muted-foreground">TTS in chat — 10 per day free</div>
        </div>
        <div className="border rounded-xl p-3 text-center">
