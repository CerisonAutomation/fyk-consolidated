	...
	return (
		...
		>
			...
			<div className="absolute inset-0 pointer-events-none"
				style={{ background: 'radial-gradient(ellipse 80% 50% at 50% 0%, rgba(234,179,8,0.06) 0%, transparent 60%)' }} />
			<div className="absolute inset-0 pointer-events-none"
				style={{ background: 'radial-gradient(ellipse 60% 40% at 20% 80%, rgba(168,85,247,0.05) 0%, transparent 60%)' }} />
			...
			<div className="w-full max-w-md space-y-6 relative z-10">
				...
				<div className="flex flex-col items-center gap-4"
					...
					<div className="flex items-center justify-center">
						<img src="/logo-horizontal.svg" alt="FYKING" className="h-8 w-auto"
							style={{ filter: 'drop-shadow(0 0 20px rgba(234,179,8,0.2))' }} />
					</div>
				</div>

				<div className="text-center" style={{ animation: 'auth-slideUp 0.6s ease-out 0.2s both' }}>
				...
				<div className="rounded-2xl p-6 sm:p-7 relative overflow-hidden"
					style={{ ...GLASS_CARD_STYLE, animation: 'auth-slideUp 0.6s ease-out 0.3s both' }}>

					{error && (
						<div className="mb-4 rounded-lg p-3 text-sm text-red-400"
						...
						<div className="space-y-2">
							...
							{password.length > 0 && (
								<div className="space-y-1">
									...
									<p className="text-[11px]" style={{ color: strengthColors[passwordStrength] }}>
				...
				{/* Mode switcher */}
				<div className="text-center" style={{ animation: 'auth-slideUp 0.6s ease-out 0.5s both' }}>
					<p className="text-xs text-white/40">
						Already have an account?{' '}
						<a href="/auth/sign-in" className="text-amber-400 hover:text-amber-300 transition font-medium">
							Sign in
						</a>
					</p>
				</div>
				...
				<div className="flex items-center justify-center gap-5"
					...
					{[
						...
						<div key={t.text} className="flex items-center gap-1.5">
							...
							<span className="text-white/25 font-mono uppercase tracking-wider"
