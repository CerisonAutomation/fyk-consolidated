  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => ({
      items: Array.from({ length: 6 }, (_, i) => ({
        id: `${"community-challenges"}-${i}`,
        title: `${"community-challenges"} ${i + 1}`,
        description: "Community challenges with XP, streak, leaderboard",
      })),
    }),
  });
  ...
  return (
    <div className="mx-auto max-w-3xl p-4 pb-24">
      <div className="mb-6 rounded-[20px] border border-black/[0.06] bg-white p-5 shadow-sm">
        ...
        <p className="mt-1 text-[14px] text-zinc-500">Community challenges with XP, streak, leaderboard</p>
      </div>
