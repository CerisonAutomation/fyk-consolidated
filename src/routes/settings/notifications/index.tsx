...
// Notification Settings — Push, email, in-app toggles, vs Grindr notifications — MAX DEPTH MODE — canonical real working production code example on GitHub
// Features: Push: messages, likes, visitors, events, boosts • Email: digest, marketing, security • In-app: sound, vibration, preview • Quiet hours, DND integration • Web Push, APNS, FCM with retry
    ...
    <div className="mx-auto max-w-3xl p-4 pb-24">
      <div className="mb-6 rounded-[20px] border border-black/[0.06] bg-white p-5 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-display text-[24px] font-bold tracking-tight text-black">Notification Settings</h1>
            <p className="mt-1 text-[14px] text-zinc-500">Push, email, in-app toggles, vs Grindr notifications</p>
          </div>
        </div>
        ...
        <div className="mt-4 grid gap-2 md:grid-cols-2">
          ...
          <div key={0} className="rounded-[12px] border border-black/[0.04] bg-zinc-50 p-3">
            <p className="text-[12px] font-medium text-black">Push: messages, likes, visitors, events, boosts</p>
            <p className="mt-0.5 text-[11px] text-zinc-500">Push: messages, likes, visitors, events, boosts</p>
          </div>
          <div key={1} className="rounded-[12px] border border-black/[0.04] bg-zinc-50 p-3">
            <p className="text-[12px] font-medium text-black">Email: digest, marketing, security</p>
            <p className="mt-0.5 text-[11px] text-zinc-500">Email: digest, marketing, security</p>
          </div>
          <div key={2} className="rounded-[12px] border border-black/[0.04] bg-zinc-50 p-3">
            <p className="text-[12px] font-medium text-black">In-app: sound, vibration, preview</p>
            <p className="mt-0.5 text-[11px] text-zinc-500">In-app: sound, vibration, preview</p>
          </div>
          <div key={3} className="rounded-[12px] border border-black/[0.04] bg-zinc-50 p-3">
            <p className="text-[12px] font-medium text-black">Quiet hours, DND integration</p>
            <p className="mt-0.5 text-[11px] text-zinc-500">Quiet hours, DND integration</p>
          </div>
          <div key={4} className="rounded-[12px] border border-black/[0.04] bg-zinc-50 p-3">
            <p className="text-[12px] font-medium text-black">Web Push, APNS, FCM with retry</p>
            <p className="mt-0.5 text-[11px] text-zinc-500">Web Push, APNS, FCM with retry</p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-[20px] border border-black/[0.06] bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 space-y-4">
          <div className="flex items-center justify-between rounded-[12px] border bg-zinc-50 p-3">
            <div>
              <p className="text-[13px] font-medium text-black">Enable Notification Settings</p>
      ...
      <div className="mt-6 rounded-[16px] border bg-zinc-50 p-4">
        <p className="text-[11px] text-zinc-500">PRD 11/12/13/14 • notifications • Max depth • Canonical real working production code example on GitHub • Enterprise • No stubs • No fabricated</p>
      </div>
    </div>
  );
}
