...
// Location Settings — Geohash, hide real GPS, travel mode, vs Grindr location — MAX DEPTH MODE — canonical real working production code example on GitHub
// Features: Geohash precision, hide real GPS • Travel mode 2 weeks prior, vs Romeo travel • Distance visibility exact/approximate/hide • Location history, clear • Permissions, background location

export const Route = createFileRoute("/settings/location/")({
    ...
    <div className="mx-auto max-w-3xl p-4 pb-24">
      <div className="mb-6 rounded-[20px] border border-black/[0.06] bg-white p-5 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-display text-[24px] font-bold tracking-tight text-black">Location Settings</h1>
            <p className="mt-1 text-[14px] text-zinc-500">Geohash, hide real GPS, travel mode, vs Grindr location</p>
          </div>
        </div>
        ...
        <div className="mt-4 grid gap-2 md:grid-cols-2">
          ...
          <div key={0} className="rounded-[12px] border border-black/[0.04] bg-zinc-50 p-3">
            <p className="text-[12px] font-medium text-black">Geohash precision, hide real GPS</p>
            <p className="mt-0.5 text-[11px] text-zinc-500">Geohash precision, hide real GPS</p>
          </div>
          <div key={1} className="rounded-[12px] border border-black/[0.04] bg-zinc-50 p-3">
            <p className="text-[12px] font-medium text-black">Travel mode 2 weeks prior, vs Romeo travel</p>
            <p className="mt-0.5 text-[11px] text-zinc-500">Travel mode 2 weeks prior, vs Romeo travel</p>
          </div>
          <div key={2} className="rounded-[12px] border border-black/[0.04] bg-zinc-50 p-3">
            <p className="text-[12px] font-medium text-black">Distance visibility exact/approximate/hide</p>
            <p className="mt-0.5 text-[11px] text-zinc-500">Distance visibility exact/approximate/hide</p>
          </div>
          <div key={3} className="rounded-[12px] border border-black/[0.04] bg-zinc-50 p-3">
            <p className="text-[12px] font-medium text-black">Location history, clear</p>
            <p className="mt-0.5 text-[11px] text-zinc-500">Location history, clear</p>
          </div>
          <div key={4} className="rounded-[12px] border border-black/[0.04] bg-zinc-50 p-3">
            <p className="text-[12px] font-medium text-black">Permissions, background location</p>
            <p className="mt-0.5 text-[11px] text-zinc-500">Permissions, background location</p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-[20px] border border-black/[0.06] bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 space-y-4">
          <div className="flex items-center justify-between rounded-[12px] border bg-zinc-50 p-3">
            <div>
              <p className="text-[13px] font-medium text-black">Enable Location Settings</p>
      ...
      <div className="mt-6 rounded-[16px] border bg-zinc-50 p-4">
        <p className="text-[11px] text-zinc-500">PRD 11/12/13/14 • location • Max depth • Canonical real working production code example on GitHub • Enterprise • No stubs • No fabricated</p>
      </div>
    </div>
  );
}
