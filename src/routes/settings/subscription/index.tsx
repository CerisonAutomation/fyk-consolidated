...
// subscription — Subscription with Free/Gold/Platinum tiers, Stripe, RevenueCat, billing, cancel — PRD v3.0 100% grounded, polished, enterprise
    ...
    queryFn: async () => {
      ...
      return {
        items: Array.from({ length: 8 }, (_, i) => ({
          ...
          description: "Subscription with Free/Gold/Platinum tiers, Stripe, RevenueCat, billing, cancel",
        })),
      };
    },
  });
  ...
  return (
    <div className="mx-auto max-w-3xl p-4 pb-24">
      <div className="mb-6 rounded-[20px] border border-black/[0.06] bg-white p-5 shadow-sm">
        ...
        <p className="mt-1 text-[14px] text-zinc-500">Subscription with Free/Gold/Platinum tiers, Stripe, RevenueCat, billing, cancel</p>
      </div>
      ...
      <div className="mt-6 rounded-[16px] border bg-zinc-50 p-4">
        <p className="text-[12px] text-zinc-500">PRD v3.0 • subscription • 100% grounded • Polished • Enterprise • No hyperbol</p>
      </div>
    </div>
  );
}
