				...
				<div className="mx-auto max-w-lg px-4 py-4 pb-24">
					...
					<div className="space-y-2">
						<button
							type="button"
							disabled
							className="glass-card flex w-full cursor-not-allowed items-center gap-3 px-4 py-3 text-left opacity-60"
						>
							<div
								className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl"
								style={{
							...
							<div className="min-w-0 flex-1">
								...
								<p className="mt-0.5 text-xs text-white/40">
									Available after connecting a live account
								</p>
							</div>
							<svg
								aria-hidden="true"
					...
					<div className="space-y-2">
						<button
							type="button"
							disabled
							className="flex w-full cursor-not-allowed items-center gap-3 rounded-xl border border-red-500/20 bg-red-500/5 px-4 py-3 text-left opacity-60"
						>
							...
							<div className="min-w-0 flex-1">
								...
								<p className="mt-0.5 text-xs text-white/30">
									Requires a connected live account
								</p>
							</div>
						</button>
